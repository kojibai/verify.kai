...
export default function KaiSplashScreen(): React.JSX.Element | null {
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      if (readyListener) window.removeEventListener("load", readyListener);
